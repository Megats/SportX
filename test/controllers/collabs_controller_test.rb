...
class CollabsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create collab" do
    assert_difference("Collab.count") do
      post collabs_url, params: { collab: { donation_fee: @collab.donation_fee, org_name: @collab.org_name, overview: @collab.overview } }
    end
  ...
  test "should update collab" do
    patch collab_url(@collab), params: { collab: { donation_fee: @collab.donation_fee, org_name: @collab.org_name, overview: @collab.overview } }
