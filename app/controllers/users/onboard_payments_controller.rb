class Users::OnboardPaymentsController < ApplicationController
        ...
        respond_to do |format|
          if @participant.save
            if !@participant.parent_id.nil?
              format.html { redirect_to user_event_onboard_payments_path(id: @participant.parent_id,event_id: @event), notice: "Create user Success" }
            else
              format.html { redirect_to user_event_onboard_payments_path(id: @participant,event_id: @event), notice: "Create user Success" }
            end
          end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to user_event_onboard_payments_path(id: @participant.parent_id,event_id: @event), notice: "Participant was successfully destroyed." }
